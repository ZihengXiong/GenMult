...
<!-- last-verified-commit: 04ca7028ff3c4ef83e84f0e5a4f1c3148bf8f68c -->

## 最近一次全量验证

- **基线 commit**: 见上方 `last-verified-commit` 标记（`scripts/test-changed.sh --update` 自动维护，branch `feat/agenthub-projection-idempotency`）
- **日期**: 2026-06-11
- **结论**: 全部通过
