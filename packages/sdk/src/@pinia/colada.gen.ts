...
export const getAgentHubRoomsQueryKey = (options?: Options<GetAgentHubRoomsData>) => createQueryKey('getAgentHubRooms', options);

/**
 * List AgentHub rooms
 *
 * List AgentHub group rooms owned by the current user.
 */
export const getAgentHubRoomsQuery = defineQueryOptions((options?: Options<GetAgentHubRoomsData>) => ({
    key: getAgentHubRoomsQueryKey(options),
    query: async (context) => {
        const { data } = await getAgentHubRooms({
            ...options,
            ...context,
            throwOnError: true
        });
...
/**
 * Create AgentHub room
 *
 * Create an AgentHub group room and optional initial agent membership.
 */
export const postAgentHubRoomsMutation = (options?: Partial<Options<PostAgentHubRoomsData>>): UseMutationOptions<PostAgentHubRoomsResponse, Options<PostAgentHubRoomsData>, PostAgentHubRoomsError> => ({
    mutation: async (vars) => {
        const { data } = await postAgentHubRooms({
            ...options,
            ...vars,
            throwOnError: true
        });
...
/**
 * Delete AgentHub room
 *
 * Delete an AgentHub group room.
 */
export const deleteAgentHubRoomsByRoomIdMutation = (options?: Partial<Options<DeleteAgentHubRoomsByRoomIdData>>): UseMutationOptions<unknown, Options<DeleteAgentHubRoomsByRoomIdData>, DeleteAgentHubRoomsByRoomIdError> => ({
    mutation: async (vars) => {
        const { data } = await deleteAgentHubRoomsByRoomId({
            ...options,
            ...vars,
            throwOnError: true
        });
...
export const getAgentHubRoomsByRoomIdQueryKey = (options: Options<GetAgentHubRoomsByRoomIdData>) => createQueryKey('getAgentHubRoomsByRoomId', options);

/**
 * Get AgentHub room
 *
 * Get an AgentHub group room by id.
 */
export const getAgentHubRoomsByRoomIdQuery = defineQueryOptions((options: Options<GetAgentHubRoomsByRoomIdData>) => ({
    key: getAgentHubRoomsByRoomIdQueryKey(options),
    query: async (context) => {
        const { data } = await getAgentHubRoomsByRoomId({
            ...options,
            ...context,
            throwOnError: true
        });
...
/**
 * Update AgentHub room
 *
 * Update an AgentHub group room and its agent membership.
 */
export const putAgentHubRoomsByRoomIdMutation = (options?: Partial<Options<PutAgentHubRoomsByRoomIdData>>): UseMutationOptions<PutAgentHubRoomsByRoomIdResponse, Options<PutAgentHubRoomsByRoomIdData>, PutAgentHubRoomsByRoomIdError> => ({
    mutation: async (vars) => {
        const { data } = await putAgentHubRoomsByRoomId({
            ...options,
            ...vars,
            throwOnError: true
        });
...
/**
 * Add AgentHub room agent
 *
 * Add an agent member to an AgentHub group room.
 */
export const postAgentHubRoomsByRoomIdAgentsMutation = (options?: Partial<Options<PostAgentHubRoomsByRoomIdAgentsData>>): UseMutationOptions<PostAgentHubRoomsByRoomIdAgentsResponse, Options<PostAgentHubRoomsByRoomIdAgentsData>, PostAgentHubRoomsByRoomIdAgentsError> => ({
    mutation: async (vars) => {
        const { data } = await postAgentHubRoomsByRoomIdAgents({
            ...options,
            ...vars,
            throwOnError: true
        });
...
/**
 * Remove AgentHub room agent
 *
 * Remove an agent member from an AgentHub group room.
 */
export const deleteAgentHubRoomsByRoomIdAgentsByAgentIdMutation = (options?: Partial<Options<DeleteAgentHubRoomsByRoomIdAgentsByAgentIdData>>): UseMutationOptions<DeleteAgentHubRoomsByRoomIdAgentsByAgentIdResponse, Options<DeleteAgentHubRoomsByRoomIdAgentsByAgentIdData>, DeleteAgentHubRoomsByRoomIdAgentsByAgentIdError> => ({
    mutation: async (vars) => {
        const { data } = await deleteAgentHubRoomsByRoomIdAgentsByAgentId({
            ...options,
            ...vars,
            throwOnError: true
        });
...
export const getAgentHubRoomsByRoomIdMessagesQueryKey = (options: Options<GetAgentHubRoomsByRoomIdMessagesData>) => createQueryKey('getAgentHubRoomsByRoomIdMessages', options);

/**
 * List AgentHub room messages
 *
 * List persisted timeline messages for an AgentHub group room.
 */
export const getAgentHubRoomsByRoomIdMessagesQuery = defineQueryOptions((options: Options<GetAgentHubRoomsByRoomIdMessagesData>) => ({
    key: getAgentHubRoomsByRoomIdMessagesQueryKey(options),
    query: async (context) => {
        const { data } = await getAgentHubRoomsByRoomIdMessages({
            ...options,
            ...context,
            throwOnError: true
        });
...
/**
 * Create AgentHub room message
 *
 * Append a message to an AgentHub group room timeline.
 */
export const postAgentHubRoomsByRoomIdMessagesMutation = (options?: Partial<Options<PostAgentHubRoomsByRoomIdMessagesData>>): UseMutationOptions<PostAgentHubRoomsByRoomIdMessagesResponse, Options<PostAgentHubRoomsByRoomIdMessagesData>, PostAgentHubRoomsByRoomIdMessagesError> => ({
    mutation: async (vars) => {
        const { data } = await postAgentHubRoomsByRoomIdMessages({
            ...options,
            ...vars,
            throwOnError: true
        });
...
/**
 * Start AgentHub orchestration run
 *
 * Plan objective into tasks and optionally dispatch immediately.
 */
export const postAgentHubRoomsByRoomIdRunsMutation = (options?: Partial<Options<PostAgentHubRoomsByRoomIdRunsData>>): UseMutationOptions<PostAgentHubRoomsByRoomIdRunsResponse, Options<PostAgentHubRoomsByRoomIdRunsData>, PostAgentHubRoomsByRoomIdRunsError> => ({
    mutation: async (vars) => {
        const { data } = await postAgentHubRoomsByRoomIdRuns({
            ...options,
            ...vars,
            throwOnError: true
        });
...
/**
 * Reconcile all active AgentHub runs for current owner
 *
 * Trigger reconciliation for planning/dispatching/collecting runs.
 */
export const postAgentHubRunsReconcileActiveMutation = (options?: Partial<Options<PostAgentHubRunsReconcileActiveData>>): UseMutationOptions<PostAgentHubRunsReconcileActiveResponse, Options<PostAgentHubRunsReconcileActiveData>, PostAgentHubRunsReconcileActiveError> => ({
    mutation: async (vars) => {
        const { data } = await postAgentHubRunsReconcileActive({
            ...options,
            ...vars,
            throwOnError: true
        });
...
export const getAgentHubRunsByRunIdQueryKey = (options: Options<GetAgentHubRunsByRunIdData>) => createQueryKey('getAgentHubRunsByRunId', options);

/**
 * Get AgentHub orchestration run snapshot
 *
 * Return run state, tasks, dependencies and attempts.
 */
export const getAgentHubRunsByRunIdQuery = defineQueryOptions((options: Options<GetAgentHubRunsByRunIdData>) => ({
    key: getAgentHubRunsByRunIdQueryKey(options),
    query: async (context) => {
        const { data } = await getAgentHubRunsByRunId({
            ...options,
            ...context,
            throwOnError: true
        });
 ...
 * Cancel AgentHub run
 *
 * Cancel a run and mark non-terminal tasks cancelled.
 */
export const postAgentHubRunsByRunIdCancelMutation = (options?: Partial<Options<PostAgentHubRunsByRunIdCancelData>>): UseMutationOptions<PostAgentHubRunsByRunIdCancelResponse, Options<PostAgentHubRunsByRunIdCancelData>, PostAgentHubRunsByRunIdCancelError> => ({
    mutation: async (vars) => {
        const { data } = await postAgentHubRunsByRunIdCancel({
            ...options,
            ...vars,
            throwOnError: true
        });
...
export const getAgentHubRunsByRunIdEventsQueryKey = (options: Options<GetAgentHubRunsByRunIdEventsData>) => createQueryKey('getAgentHubRunsByRunIdEvents', options);

/**
 * List AgentHub run events
 *
 * Return append-only orchestrator events for timeline projection.
 */
export const getAgentHubRunsByRunIdEventsQuery = defineQueryOptions((options: Options<GetAgentHubRunsByRunIdEventsData>) => ({
    key: getAgentHubRunsByRunIdEventsQueryKey(options),
    query: async (context) => {
        const { data } = await getAgentHubRunsByRunIdEvents({
            ...options,
            ...context,
            throwOnError: true
        });
...
/**
 * Reconcile AgentHub run
 *
 * Recompute task readiness, dispatch runnable tasks, and advance run status.
 */
export const postAgentHubRunsByRunIdReconcileMutation = (options?: Partial<Options<PostAgentHubRunsByRunIdReconcileData>>): UseMutationOptions<PostAgentHubRunsByRunIdReconcileResponse, Options<PostAgentHubRunsByRunIdReconcileData>, PostAgentHubRunsByRunIdReconcileError> => ({
    mutation: async (vars) => {
        const { data } = await postAgentHubRunsByRunIdReconcile({
            ...options,
            ...vars,
            throwOnError: true
        });
