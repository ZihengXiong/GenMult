 ...
 */
export const getAgentHubRooms = <ThrowOnError extends boolean = false>(options?: Options<GetAgentHubRoomsData, ThrowOnError>) => (options?.client ?? client).get<GetAgentHubRoomsResponses, GetAgentHubRoomsErrors, ThrowOnError>({ url: '/agent-hub/rooms', ...options });
 ...
 */
export const postAgentHubRooms = <ThrowOnError extends boolean = false>(options: Options<PostAgentHubRoomsData, ThrowOnError>) => (options.client ?? client).post<PostAgentHubRoomsResponses, PostAgentHubRoomsErrors, ThrowOnError>({
    url: '/agent-hub/rooms',
    ...options,
    headers: {
 ...
 */
export const deleteAgentHubRoomsByRoomId = <ThrowOnError extends boolean = false>(options: Options<DeleteAgentHubRoomsByRoomIdData, ThrowOnError>) => (options.client ?? client).delete<DeleteAgentHubRoomsByRoomIdResponses, DeleteAgentHubRoomsByRoomIdErrors, ThrowOnError>({ url: '/agent-hub/rooms/{room_id}', ...options });
 ...
 */
export const getAgentHubRoomsByRoomId = <ThrowOnError extends boolean = false>(options: Options<GetAgentHubRoomsByRoomIdData, ThrowOnError>) => (options.client ?? client).get<GetAgentHubRoomsByRoomIdResponses, GetAgentHubRoomsByRoomIdErrors, ThrowOnError>({ url: '/agent-hub/rooms/{room_id}', ...options });
 ...
 */
export const putAgentHubRoomsByRoomId = <ThrowOnError extends boolean = false>(options: Options<PutAgentHubRoomsByRoomIdData, ThrowOnError>) => (options.client ?? client).put<PutAgentHubRoomsByRoomIdResponses, PutAgentHubRoomsByRoomIdErrors, ThrowOnError>({
 ...
 */
export const postAgentHubRoomsByRoomIdAgents = <ThrowOnError extends boolean = false>(options: Options<PostAgentHubRoomsByRoomIdAgentsData, ThrowOnError>) => (options.client ?? client).post<PostAgentHubRoomsByRoomIdAgentsResponses, PostAgentHubRoomsByRoomIdAgentsErrors, ThrowOnError>({
 ...
 */
export const deleteAgentHubRoomsByRoomIdAgentsByAgentId = <ThrowOnError extends boolean = false>(options: Options<DeleteAgentHubRoomsByRoomIdAgentsByAgentIdData, ThrowOnError>) => (options.client ?? client).delete<DeleteAgentHubRoomsByRoomIdAgentsByAgentIdResponses, DeleteAgentHubRoomsByRoomIdAgentsByAgentIdErrors, ThrowOnError>({ url: '/agent-hub/rooms/{room_id}/agents/{agent_id}', ...options });
 ...
 */
export const getAgentHubRoomsByRoomIdMessages = <ThrowOnError extends boolean = false>(options: Options<GetAgentHubRoomsByRoomIdMessagesData, ThrowOnError>) => (options.client ?? client).get<GetAgentHubRoomsByRoomIdMessagesResponses, GetAgentHubRoomsByRoomIdMessagesErrors, ThrowOnError>({ url: '/agent-hub/rooms/{room_id}/messages', ...options });
 ...
 */
export const postAgentHubRoomsByRoomIdMessages = <ThrowOnError extends boolean = false>(options: Options<PostAgentHubRoomsByRoomIdMessagesData, ThrowOnError>) => (options.client ?? client).post<PostAgentHubRoomsByRoomIdMessagesResponses, PostAgentHubRoomsByRoomIdMessagesErrors, ThrowOnError>({
 ...
 */
export const postAgentHubRoomsByRoomIdRuns = <ThrowOnError extends boolean = false>(options: Options<PostAgentHubRoomsByRoomIdRunsData, ThrowOnError>) => (options.client ?? client).post<PostAgentHubRoomsByRoomIdRunsResponses, PostAgentHubRoomsByRoomIdRunsErrors, ThrowOnError>({
 ...
 */
export const postAgentHubRunsReconcileActive = <ThrowOnError extends boolean = false>(options?: Options<PostAgentHubRunsReconcileActiveData, ThrowOnError>) => (options?.client ?? client).post<PostAgentHubRunsReconcileActiveResponses, PostAgentHubRunsReconcileActiveErrors, ThrowOnError>({ url: '/agent-hub/runs/reconcile-active', ...options });
 ...
 */
export const getAgentHubRunsByRunId = <ThrowOnError extends boolean = false>(options: Options<GetAgentHubRunsByRunIdData, ThrowOnError>) => (options.client ?? client).get<GetAgentHubRunsByRunIdResponses, GetAgentHubRunsByRunIdErrors, ThrowOnError>({ url: '/agent-hub/runs/{run_id}', ...options });
 ...
 */
export const postAgentHubRunsByRunIdCancel = <ThrowOnError extends boolean = false>(options: Options<PostAgentHubRunsByRunIdCancelData, ThrowOnError>) => (options.client ?? client).post<PostAgentHubRunsByRunIdCancelResponses, PostAgentHubRunsByRunIdCancelErrors, ThrowOnError>({ url: '/agent-hub/runs/{run_id}/cancel', ...options });
 ...
 */
export const getAgentHubRunsByRunIdEvents = <ThrowOnError extends boolean = false>(options: Options<GetAgentHubRunsByRunIdEventsData, ThrowOnError>) => (options.client ?? client).get<GetAgentHubRunsByRunIdEventsResponses, GetAgentHubRunsByRunIdEventsErrors, ThrowOnError>({ url: '/agent-hub/runs/{run_id}/events', ...options });
 ...
 */
export const postAgentHubRunsByRunIdReconcile = <ThrowOnError extends boolean = false>(options: Options<PostAgentHubRunsByRunIdReconcileData, ThrowOnError>) => (options.client ?? client).post<PostAgentHubRunsByRunIdReconcileResponses, PostAgentHubRunsByRunIdReconcileErrors, ThrowOnError>({ url: '/agent-hub/runs/{run_id}/reconcile', ...options });
