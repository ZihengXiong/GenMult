<template>
  <div class="flex-1 flex flex-col h-full min-w-0 relative">
    ...
    <template v-else>
      <section class="flex-1 relative w-full bg-background px-3 sm:px-5 lg:px-8">
        <section class="absolute inset-0">
          ...
          >
            <div            
              class="w-full max-w-4xl mx-auto px-8 pt-6 pb-6 space-y-5"
            >
              <div
      ...
      <div
        ...
        class="bg-background/95 px-3 py-3 backdrop-blur sm:px-5 lg:px-8"
      >
        <div class="w-full max-w-4xl mx-auto">
          ...
          <section>
            ...
            <InputGroup class="overflow-hidden rounded-lg! border-border! bg-card shadow-sm! ring-0!">
              <InputGroupTextarea
                v-model="inputText"
                class="min-h-20 max-h-32 resize-none break-all! px-3 py-2 text-sm"
