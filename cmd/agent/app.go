...
import (
	...
	"github.com/ZihengXiong/GenMult/internal/channel/adapters/dingtalk"
	"github.com/ZihengXiong/GenMult/internal/channel/adapters/discord"
	"github.com/ZihengXiong/GenMult/internal/channel/adapters/feishu"
	"github.com/ZihengXiong/GenMult/internal/channel/adapters/local"
	"github.com/ZihengXiong/GenMult/internal/channel/adapters/matrix"
	"github.com/ZihengXiong/GenMult/internal/channel/adapters/misskey"
	"github.com/ZihengXiong/GenMult/internal/channel/adapters/qq"
	slackadapter "github.com/ZihengXiong/GenMult/internal/channel/adapters/slack"
	"github.com/ZihengXiong/GenMult/internal/channel/adapters/telegram"
	"github.com/ZihengXiong/GenMult/internal/channel/adapters/wechatoa"
	"github.com/ZihengXiong/GenMult/internal/channel/adapters/wecom"
	...
	"github.com/ZihengXiong/GenMult/internal/channel/inbound"
	...
	containerprovider "github.com/ZihengXiong/GenMult/internal/container/provider"
	...
	emailgeneric "github.com/ZihengXiong/GenMult/internal/email/adapters/generic"
	emailgmail "github.com/ZihengXiong/GenMult/internal/email/adapters/gmail"
	emailmailgun "github.com/ZihengXiong/GenMult/internal/email/adapters/mailgun"
	"github.com/ZihengXiong/GenMult/internal/handlers"
	"github.com/ZihengXiong/GenMult/internal/healthcheck"
	channelchecker "github.com/ZihengXiong/GenMult/internal/healthcheck/checkers/channel"
	mcpchecker "github.com/ZihengXiong/GenMult/internal/healthcheck/checkers/mcp"
	modelchecker "github.com/ZihengXiong/GenMult/internal/healthcheck/checkers/model"
	...
	mcpfederation "github.com/ZihengXiong/GenMult/internal/mcp/sources/federation"
	"github.com/ZihengXiong/GenMult/internal/media"
	memprovider "github.com/ZihengXiong/GenMult/internal/memory/adapters"
	membuiltin "github.com/ZihengXiong/GenMult/internal/memory/adapters/builtin"
	memmem0 "github.com/ZihengXiong/GenMult/internal/memory/adapters/mem0"
	memopenviking "github.com/ZihengXiong/GenMult/internal/memory/adapters/openviking"
	"github.com/ZihengXiong/GenMult/internal/memory/memllm"
	storefs "github.com/ZihengXiong/GenMult/internal/memory/storefs"
	"github.com/ZihengXiong/GenMult/internal/message"
	"github.com/ZihengXiong/GenMult/internal/message/event"
	"github.com/ZihengXiong/GenMult/internal/messaging"
	...
	netoverlay "github.com/ZihengXiong/GenMult/internal/network/overlay"
	...
	"github.com/ZihengXiong/GenMult/internal/registry"
	"github.com/ZihengXiong/GenMult/internal/schedule"
	"github.com/ZihengXiong/GenMult/internal/searchproviders"
	"github.com/ZihengXiong/GenMult/internal/server"
	sessionpkg "github.com/ZihengXiong/GenMult/internal/session"
	"github.com/ZihengXiong/GenMult/internal/settings"
	"github.com/ZihengXiong/GenMult/internal/storage/providers/containerfs"
	"github.com/ZihengXiong/GenMult/internal/storage/providers/fallback"
	"github.com/ZihengXiong/GenMult/internal/storage/providers/localfs"
...
func provideChannelRegistry(log *slog.Logger, hub *local.RouteHub, mediaService *media.Service, cfg config.Config) *channel.Registry {
	...
	registry.MustRegister(whatsapp.NewWhatsAppAdapter(log, cfg.Workspace.DataRoot))
...
// wireWhatsAppLifecycle injects the channel lifecycle into the WhatsApp adapter
// so it can disable the channel config when WhatsApp pushes a LoggedOut event.
func wireWhatsAppLifecycle(registry *channel.Registry, lifecycle *channel.Lifecycle) {
	adapter, ok := registry.Get(whatsapp.Type)
	if !ok {
		return
	}
	if wa, ok := adapter.(*whatsapp.WhatsAppAdapter); ok {
		wa.SetLifecycle(lifecycle)
	}
}
