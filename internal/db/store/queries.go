...
type Queries interface {
	...
	CreateAgentHubRoom(ctx context.Context, arg dbsqlc.CreateAgentHubRoomParams) (dbsqlc.AgentHubRoom, error)
	CreateAgentHubRoomMessage(ctx context.Context, arg dbsqlc.CreateAgentHubRoomMessageParams) (dbsqlc.AgentHubRoomMessage, error)
	...
	AddAgentHubRoomAgent(ctx context.Context, arg dbsqlc.AddAgentHubRoomAgentParams) error
	...
	UpdateAgentHubRoom(ctx context.Context, arg dbsqlc.UpdateAgentHubRoomParams) (dbsqlc.AgentHubRoom, error)
