...
func (q *Queries) AddAgentHubRoomAgent(ctx context.Context, arg pgsqlc.AddAgentHubRoomAgentParams) error {
	if q == nil || q.store == nil || q.store.queries == nil {
		return errSQLiteQueriesNotConfigured
	}
	var sqliteArg sqlitesqlc.AddAgentHubRoomAgentParams
	if err := convertValue(arg, &sqliteArg); err != nil {
		return err
	}
	err := q.store.queries.AddAgentHubRoomAgent(ctx, sqliteArg)
	return mapQueryErr(err)
}

func (q *Queries) CreateAgentHubRoom(ctx context.Context, arg pgsqlc.CreateAgentHubRoomParams) (pgsqlc.AgentHubRoom, error) {
	if q == nil || q.store == nil || q.store.queries == nil {
		return pgsqlc.AgentHubRoom{}, errSQLiteQueriesNotConfigured
	}
	var sqliteArg sqlitesqlc.CreateAgentHubRoomParams
	if err := convertValue(arg, &sqliteArg); err != nil {
		return pgsqlc.AgentHubRoom{}, err
	}
	out, err := q.store.queries.CreateAgentHubRoom(ctx, sqliteArg)
	if err != nil {
		return pgsqlc.AgentHubRoom{}, mapQueryErr(err)
	}
	var result pgsqlc.AgentHubRoom
...
func (q *Queries) CreateAgentHubRoomMessage(ctx context.Context, arg pgsqlc.CreateAgentHubRoomMessageParams) (pgsqlc.AgentHubRoomMessage, error) {
	if q == nil || q.store == nil || q.store.queries == nil {
		return pgsqlc.AgentHubRoomMessage{}, errSQLiteQueriesNotConfigured
	}
	var sqliteArg sqlitesqlc.CreateAgentHubRoomMessageParams
	if err := convertValue(arg, &sqliteArg); err != nil {
		return pgsqlc.AgentHubRoomMessage{}, err
	}
	out, err := q.store.queries.CreateAgentHubRoomMessage(ctx, sqliteArg)
	if err != nil {
...
func (q *Queries) DeleteAgentHubRoom(ctx context.Context, arg pgsqlc.DeleteAgentHubRoomParams) error {
	if q == nil || q.store == nil || q.store.queries == nil {
		return errSQLiteQueriesNotConfigured
	}
	var sqliteArg sqlitesqlc.DeleteAgentHubRoomParams
	if err := convertValue(arg, &sqliteArg); err != nil {
		return err
	}
	err := q.store.queries.DeleteAgentHubRoom(ctx, sqliteArg)
	return mapQueryErr(err)
}
...
func (q *Queries) DeleteAgentHubRoomAgent(ctx context.Context, arg pgsqlc.DeleteAgentHubRoomAgentParams) error {
	...
	var sqliteArg sqlitesqlc.DeleteAgentHubRoomAgentParams
	if err := convertValue(arg, &sqliteArg); err != nil {
		return err
	}
	err := q.store.queries.DeleteAgentHubRoomAgent(ctx, sqliteArg)
	return mapQueryErr(err)
}

func (q *Queries) GetAgentHubRoom(ctx context.Context, arg pgsqlc.GetAgentHubRoomParams) (pgsqlc.AgentHubRoom, error) {
	if q == nil || q.store == nil || q.store.queries == nil {
		return pgsqlc.AgentHubRoom{}, errSQLiteQueriesNotConfigured
	}
	var sqliteArg sqlitesqlc.GetAgentHubRoomParams
	if err := convertValue(arg, &sqliteArg); err != nil {
		return pgsqlc.AgentHubRoom{}, err
	}
	out, err := q.store.queries.GetAgentHubRoom(ctx, sqliteArg)
	if err != nil {
		return pgsqlc.AgentHubRoom{}, mapQueryErr(err)
	}
	var result pgsqlc.AgentHubRoom
...
func (q *Queries) ListAgentHubRoomAgentsByOwner(ctx context.Context, ownerUserID pgtype.UUID) ([]pgsqlc.AgentHubRoomAgent, error) {
	...
	out, err := q.store.queries.ListAgentHubRoomAgentsByOwner(ctx, sqliteOwnerUserID)
	if err != nil {
...
func (q *Queries) ListAgentHubRooms(ctx context.Context, ownerUserID pgtype.UUID) ([]pgsqlc.AgentHubRoom, error) {
	if q == nil || q.store == nil || q.store.queries == nil {
		return nil, errSQLiteQueriesNotConfigured
	}
	var sqliteOwnerUserID string
	...
	out, err := q.store.queries.ListAgentHubRooms(ctx, sqliteOwnerUserID)
	if err != nil {
		return nil, mapQueryErr(err)
	}
	var result []pgsqlc.AgentHubRoom
...
func (q *Queries) ListAgentHubRoomMessages(ctx context.Context, arg pgsqlc.ListAgentHubRoomMessagesParams) ([]pgsqlc.AgentHubRoomMessage, error) {
	if q == nil || q.store == nil || q.store.queries == nil {
		return nil, errSQLiteQueriesNotConfigured
	}
	var sqliteArg sqlitesqlc.ListAgentHubRoomMessagesParams
	if err := convertValue(arg, &sqliteArg); err != nil {
		return nil, err
	}
	out, err := q.store.queries.ListAgentHubRoomMessages(ctx, sqliteArg)
	if err != nil {
		return nil, mapQueryErr(err)
	}
	var result []pgsqlc.AgentHubRoomMessage
...
func (q *Queries) UpdateAgentHubRoom(ctx context.Context, arg pgsqlc.UpdateAgentHubRoomParams) (pgsqlc.AgentHubRoom, error) {
	if q == nil || q.store == nil || q.store.queries == nil {
		return pgsqlc.AgentHubRoom{}, errSQLiteQueriesNotConfigured
	}
	var sqliteArg sqlitesqlc.UpdateAgentHubRoomParams
	if err := convertValue(arg, &sqliteArg); err != nil {
		return pgsqlc.AgentHubRoom{}, err
	}
	out, err := q.store.queries.UpdateAgentHubRoom(ctx, sqliteArg)
	if err != nil {
		return pgsqlc.AgentHubRoom{}, mapQueryErr(err)
	}
	var result pgsqlc.AgentHubRoom
